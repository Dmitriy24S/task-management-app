...
import { addNewBoard, closeModal } from '../../redux/BoardSlice/BoardSlice'
...
const NewBoardFormModal = ({ isNewBoardFormOpen }: Props) => {
  const {
    register,
    control,
    handleSubmit,
  ...
  return (
    <Modal isOpen={isNewBoardFormOpen}>
      {isNewBoardFormOpen === 'newBoardFormModal' && (
        <form
          ...
          onSubmit={handleSubmit((data) => {
            ...
            dispatch(
              addNewBoard({ boardName: data.boardName, columnsNames: data.columns })
            )
            dispatch(closeModal())
          })}
        >
