    ...
    >
      <Menu.Button className='group rounded-full p-2'>
        <BsThreeDotsVertical
          ...
          // add ui-open:fill-black dark:ui-open:fill-white/80 - fill svg + group focus/hover */}
        />
      </Menu.Button>
      <Transition
        as={Fragment}
      ...
      >
        {/* <ul className="dropdown-content menu rounded-box m-3 flex w-52 cursor-default flex-col gap-1 bg-white p-4 shadow-md focus:outline-0 dark:bg-[#2B2C37] dark:text-white"> */}
