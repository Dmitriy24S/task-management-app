...
const BoardSidebar = ({ setIsBoardMenuOpen }: BoardSidebarProps) => {
  return (
    <>
      <div
        className="backdrop fixed bg-black opacity-80 inset-0"
        onClick={() => setIsBoardMenuOpen(false)}
      ></div>
      <section className="menu absolute flex flex-col gap-3 bg-white dark:bg-[#2B2C37] p-8 rounded-md justify-center mx-auto left-0 right-0 max-w-[20rem] text-[#828FA3] fill-[#828FA3]">
        <h2 className="mb-4">All boards (3)</h2>
        ...
        <section className="theme-toggle mt-4 flex gap-4 justify-between">
